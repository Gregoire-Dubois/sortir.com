...
class ParticipantController extends AbstractController
{
     ...
     */
    public function importCsv(EntityManagerInterface $entityManager, CampusRepository $campusRepository): Response
    {
        ...
        return $this->render('admin/participant/charger_fichier_csv.html.twig', ['aNewParticipants' => $aNewParticipants]);
    }
}
